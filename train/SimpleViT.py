...
class SimpleViT(nn.Module):
    def __init__(
        ...
        if not no_input_norm:
            patch_embedding_layers.append(nn.LayerNorm(patch_dim))
        patch_embedding_layers.append(nn.Linear(patch_dim, dim))
        if not no_input_norm:
            patch_embedding_layers.append(nn.LayerNorm(dim))

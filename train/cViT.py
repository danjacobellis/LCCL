# MaxViT implementation from https://github.com/lucidrains/vit-pytorch/blob/main/vit_pytorch/max_vit_with_registers.py with 1x1 conv stem
    ...
    def __init__(
        ...
        *,
        ...
        self.conv_stem = Sequential(
            nn.Conv2d(channels, dim_conv_stem, 1, stride = 1, padding = 0),
            nn.Conv2d(dim_conv_stem, dim_conv_stem, 1, padding = 0)
        )
